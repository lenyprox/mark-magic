...
// ---------------------------------------------------------------- parser pins
// Life from the Loam is pinned again since 9.0c: "Return up to three target land cards from your graveyard to your hand" is a
// return-from-graveyard with `count: 3, optional: true` (test/scenarios/composition-cards.ts plays it).
test('staples fully parse', () => {
  for (const n of ['Life from the Loam', 'Force of Will', 'Daze', 'Force of Negation', 'Snuff Out', 'Solitude', 'Grief', 'Steam Vents', 'Seachrome Coast', 'Deserted Beach', 'Polluted Delta', 'Flooded Strand', 'Ancient Tomb', 'City of Traitors', 'Cavern of Souls', 'Mox Diamond', "Lion's Eye Diamond", 'Murktide Regent', 'Walking Ballista', 'Faithless Looting', 'Cabal Therapy', 'Leyline Binding', 'Thalia, Guardian of Thraben', 'Frogmite', 'Village Rites', 'Brainstorm', 'Ponder', 'Impulse', 'Stock Up', 'Flow State', 'Thoughtseize', 'Inquisition of Kozilek', 'Duress', 'Swords to Plowshares', 'Path to Exile', 'Fatal Push', 'Prismatic Ending', 'Stifle', 'Spell Snare', "Mishra's Bauble", 'Orcish Bowmasters', 'Reanimate', "Green Sun's Zenith", 'Stoneforge Mystic', "Dragon's Rage Channeler", 'Mox Opal', 'Sink into Stupor // Soporific Springs', 'Riverpyre Verge', 'Burst Lightning', 'Show and Tell', 'Chemister\'s Insight', 'Lotus Petal']) {
