...
export const control: Scenario[] = [
  ...
  {
    // 9.1 merge: `steal` rightly reports no change of control on your own permanent, but the sentence's untap (and
    // haste) are not conditioned on it — Threaten on your own tapped creature untaps it (CR 608.2c, 613.7).
    name: 'Threaten on your own tapped creature still untaps it and gives it haste', cr: '608.2c',
    seats: [{ bf: ['Mountain', 'Mountain', 'Mountain', 'Hill Giant'], tapped: ['Hill Giant'], hand: ['Threaten'] }, {}],
    script: [{ cast: 'Threaten', targets: [['Hill Giant']] }, { resolve: true }],
    expect: [{ tapped: ['Hill Giant', false] }, { control: ['Hill Giant', 0] }, { keywords: ['Hill Giant', ['haste']] }],
  },
];
