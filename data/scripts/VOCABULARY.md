...
| `TargetSpec.kind` | `ability` · `any` · `artifact` · `artifact-enchantment-or-nonbasic-land` · `artifact-or-enchantment` · `attacking-creature` · `blocking-creature` · `creature` · `creature-or-planeswalker` · `creature-or-player` · `creature-spell` · `enchantment` · `exiled-with-card` · `graveyard-card` · `land` · `noncreature-spell` · `nonland-permanent` · `opponent` · `permanent` · `planeswalker` · `player` · `spell` · `spell-or-nonland-permanent` · `tapped-creature` |
