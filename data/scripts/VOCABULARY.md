...
| `Amount.count` | `attached-to-source` · `blocking-source` · `card-types-in-all-graveyards` · `card-types-in-graveyard` · `cards-drawn-this-turn` · `cards-in-all-hands` · `cards-in-graveyard` · `cards-in-hand` · `colors-spent` · `commander-casts` · `counters-on-permanents` · `counters-on-source` · `counters-on-source-any` · `creatures-attacking` · `creatures-died-this-turn` · `creatures-you-control` · `domain` · `exiled-with` · `lands-you-control` · `life-lost-this-turn` · `mv-of-that` · `opponent-creatures` · `opponents` · `party` · `permanent-cards-in-graveyard` · `permanent-types-in-graveyard` · `permanents-on-battlefield` · `permanents-you-control` · `player-counters` · `power-of-source` · `power-of-that` · `spells-cast-this-turn` · `that-many` |
