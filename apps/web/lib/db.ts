...
import { DATA_DIR, MASTER_DB, projectRoot } from '@config/paths';
import type Database from 'better-sqlite3';

interface Registry { cards?: CardDB; query?: CardQueryDB; user?: Database.Database; decks?: DeckStore; games?: GameStore }
...
export function dataStatus(): { root: string; master: boolean; index: boolean; indexStale: boolean; masterBuiltAt: string | null; indexBuiltAt: string | null; userDb: boolean; manaSprite: boolean } {
