...
export interface DrawerProps { open: boolean; onClose: () => void; side?: 'left' | 'right' | 'bottom'; title?: ReactNode; children: ReactNode; width?: number; className?: string; testId?: string }
