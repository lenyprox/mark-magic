...
/**
 * What a family contributes to the script schema. `FamilySchema` is not yet declared in `src/engine/ops/types.ts`;
 * it is declared here with exactly the shape the composer expects and moves there when the composer lands.
 */
