...
/**
 * The shape every `<family>.schema.ts` exports. Declared here because src/engine/ops/types.ts does not carry it at
 * this base commit (it is a tooling type and that file is imported by the engine); the schema-composer slice adopts
